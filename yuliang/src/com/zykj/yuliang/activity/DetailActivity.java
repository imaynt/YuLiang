...
public class DetailActivity extends Activity implements View.OnClickListener {
	...
	protected void initEvents() {
		...
		View v_quanbu = flater.inflate(R.layout.activity_quanbu_content,
				log_frame, false);
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.rb_quanbu) {
			view_t = flater.inflate(R.layout.activity_quanbu_content,
					log_frame, false);
			log_frame.removeAllViews();
			log_frame.addView(view_t);
		}
		if (v.getId() == R.id.rb_renwu) {
			view_t = flater.inflate(R.layout.activity_renwu_content, log_frame,
					false);
			log_frame.removeAllViews();
			log_frame.addView(view_t);
		}
		if (v.getId() == R.id.rb_xuetu) {
			view_t = flater.inflate(R.layout.activity_xuetu_content, log_frame,
					false);
			log_frame.removeAllViews();
			log_frame.addView(view_t);
		}
		if (v.getId() == R.id.rb_duihuan) {
			view_t = flater.inflate(R.layout.activity_duihuan,log_frame, false);
			log_frame.removeAllViews();
			log_frame.addView(view_t);
		}
