...
public class NewActivity extends Activity implements OnClickListener {
	...
	String[] answer_title = { "钱咖是用来做什么的？", "我能在钱咖里做什么事情？", "钱咖能让我赚多少钱？",
			"怎么多收徒弟？", "钱咖会不会是骗子？为什么能赚钱？", "为什么有时候做完联盟任务拿不到钱？", "兑换需要多久能完成？" };
	String[] answer_o = { "帮助每个人利用空余时间赚钱，发挥自身的广告价值，使用越久收益越高。", "看看新闻，玩玩游戏，聊聊天",
			"钱咖是一款用的时间越久，收益增长越快的应用。如果坚持每天做任务，每天收徒弟，最初可以月入几百，坚持几个月下来，月入数千很轻松。",
	...
	String[] answer_t = { "一款游戏，让我打发空余时间。", "每天来完成新任务赚钱，兑换超值商品，话费充值和支付宝提现等",
			...
			"钱咖是中国第一的赚钱平台，用户发挥自身的广告价值，完成品牌主的任务获得收益，劳有所获。",
			"联盟任务是由广告联盟负责结算，有时会漏算和少算，不是钱咖所能控制的，但是钱咖一直在努力帮大家拿到该拿的奖金", "48小时内完成。" };
